            ...
            try {
                ...
                if (user.password === pHash(req.body.password)) {
                    try {
                        ...
                        res.send({ success: false, message: 'server issue L-44', error: 'Error Code : User-C-L-21' })
                    }
                } else {
            ...
            try {
                ...
                if (user) {
                    ...
                    try {
                        ...
                        res.send({ success: true, message: 'Registered successfully Please verify', email: user.email })
                    } catch (err) {
                        console.log(err)
